...
export const BurgerMenyContent = styled.nav`
  display: flex;
...
export const BurgerBooksContent = styled.div`
  margin-bottom: 42px;
  @media (max-width: 1100px) {
    margin-left: 32px;
  }
...
export const BurgerBooklist = styled.ul`
  padding-left: 20px;
  display: flex;
  flex-direction: column;
  li {
...
export const BurgerBooksLink = styled.li`
  font-family: 'Montserrat';
  font-style: normal;
  font-weight: 400;
  font-size: 16px;
...
export const BurgerBookListHead = styled.a`
  display: flex;
